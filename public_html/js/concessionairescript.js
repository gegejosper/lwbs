        ...
        console.log($('#editposition').val());
          $.ajax({
              ...
              data: {
                    ...
                    'categories': $('select[name=editcategories]').val(),
                    'meternum' : $('input[name=meternum]').val(),
                    'purok': $('select[name=purok]').val()
              },
        ...
        if($('input[name=password]').val() == $('input[name=repassword]').val()) {
            $.ajax({
                ...
                data: {
                    ...
                    'meternum' : $('input[name=meternum]').val(),
                    'purok': $('select[name=add_purok]').val()
                },
                success: function(data) {
                    if ((data.errors)){
                        ...
                        + "</td><td>" 
                        + data.meternum+"</td><td>" 
                        + data.last_name +", " + data.first_name+" " +data.middle_name+"</td><td>" 
                        + data.purok + "</td><td>"+ data.category +"</td><td class='td-actions'><button class='edit-modal btn btn-small btn-success' data-id='" + data.id + "' data-name='" + data.cat_name + "'><i class='fa fa-pencil'> </i></button><a class='delete-modal btn btn-danger btn-small' data-id='" + data.id + "' data-name='" + data.cat_name + "'><i class='fa fa-times'> </i></a></td></tr>");
                    }
