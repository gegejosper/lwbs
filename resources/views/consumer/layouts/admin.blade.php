...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Concessionaire Dashboard</title>
    ...
    <body class="skin-blue">
        ...
        <header class="header">
            <a href="/consumer/dashboard" class="logo">
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <!-- <li class="active">
                            <a href="/consumer/notification">
                                <i class="fa fa-bell-o"></i> <span>Notifications</span>
                            </a>
                        </li> -->
                        <!-- <li class="active">
                            <a href="/consumer/profile">
                                <i class="fa fa-user"></i> <span>Profile</span>
                            </a>
                        </li> -->
                        <!-- <li class="active">
                            <a href="/consumer/payment">
                                <i class="fa fa-money"></i> <span>Payment</span>
                            </a>
                        </li> -->
                        <li class="active">
                            <a href="/consumer/calculator">
