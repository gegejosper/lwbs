                        ...
                        <tbody>
                            ...
                            @foreach($collectibles as $collectible)
                                <tr class="item{{$collectible->id}}">
                                    ...
                                    <td class="td-actions">
                                        <a href="/admin/payment/{{$collectible->consumer_details->id}}" class="edit-modal btn btn-info btn-flat" ><i class="fa fa-plus"></i></a><a href="/admin/consumers/{{$collectible->consumer_details->id}}" class="edit-modal btn btn-primary btn-flat" ><i class="fa fa-search"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
