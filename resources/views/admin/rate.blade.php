                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover" id="table">
                                    ...
                                    <td>{{$Rate->id}}</td>
                                        ...
                                        <td class="td-actions">
                                            <a href="javascript:;" class=" edit-modal btn btn-small btn-success" data-id="{{$Rate->id}}" data-catname="{{$Rate->name}}" data-minimum="{{$Rate->minimum}}" data-rate="{{$Rate->rate}}" data-erate="{{$Rate->excessrate}}"><i class="fa fa-pencil"> </i></a>
                                            <!-- <a href="javascript:;" class="delete-modal btn btn-danger btn-small" data-id="{{$Rate->id}}"><i class="fa fa-times" style="color:#fff;"> </i></a></td> -->
