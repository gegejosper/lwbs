                                                ...
                                                <table class="table table-hover" id="table">
                                                    ...
                                                    <td>{{$User->meternum}}</td>
                                                       ...
                                                       {{$User->rate->name}}   
                                                        ...
                                                        if ($User->cashierbill->status != 1){
                                                            ?>
                                                            <a href="/cashier/payment/{{$User->userId}}" class="edit-modal btn btn-info btn-flat" >Add Payment</a>
                                                            <?php
                                                      }
                                                      ?>
                                                            
                                                            <a href="concessionaires/{{$User->user->id}}" class="edit-modal btn btn-primary btn-flat" >View Account Record</a>
                                                        </td>
